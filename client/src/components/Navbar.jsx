  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/' onClick={()=>setOpen(false)}>
                <img className='h-9 w-20' src={tools.ZeeZade} alt="" />
            </NavLink>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick={()=> navigate("/cart")} className="relative cursor-pointer">
                    ...
                    <button className="absolute -top-2 -right-3 text-xs text-white bg-green w-[18px] h-[18px] rounded-full">3</button>
                </div>
            ...
            {open && (
                ...
                {!user ? (
                    <button onClick={()=>{ setOpen(false); setShowUserLogin(true);}} className="cursor-pointer px-6 py-2 mt-2 bg-indigo-500 hover:bg-red-900 transition text-white rounded-full text-sm">
                    Login
                </button>
                ) : (
                    <button onClick={logout} className="cursor-pointer px-6 py-2 mt-2 bg-indigo-500 hover:bg-red-900 transition text-white rounded-full text-sm">
                    Logout
                </button>
                )}
