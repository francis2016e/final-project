...
import { features, tools } from '../assets/tools'

const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
      <img className='w-full h-100 hidden md:block' src={tools.electronics5}/>
       <img className='w-full  md:hidden' src={tools.electronics3}/>
