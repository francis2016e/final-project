            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                            ...
                            <img key={i} className='md:w-3.5 w-3' src={i<4 ? tools.star_solid : tools.star}/>
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e) =>{e.stopPropagation()}} className="text-indigo-500">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-indigo-100 border border-indigo-300 md:w-[80px] w-[64px] cursor-pointer h-[34px] rounded text-indigo-600 font-medium" onClick={() => addToCart(product._id)} >
